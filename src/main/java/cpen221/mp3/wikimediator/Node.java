...
/**
 *
 * This is an abstract class for representing an element of computation in
 * a structural query. It could represent an operator or an operand.
 *
 * If a Node represents an operator then it could represent an and
 * or or operator, and this would determine how many child nodes it has. If a node
